<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TenorDetail.aspx.cs" Inherits="DebtChecking.Facilities.TenorDetail" %>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function fnExcelReport() {
            ...
            if (msie > 0 || !!navigator.userAgent.match(/Trident.*rv\:11\./))      // If Internet Explorer
            {
                ...
                txtArea1.focus();
                sa = txtArea1.document.execCommand("SaveAs", true, "ReportTenorDetail.xls");
            }

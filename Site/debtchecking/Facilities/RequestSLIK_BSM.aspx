...
<head id="Head1" runat="server">
    <title>Request iDEB Checking</title>
...
<body onload="ubahjenis(document.getElementById('mainPanel_gender').value);">
    ...
    <div style="margin-top:50px;">
        ...
        <table width="100%" class="Box1">
            ...
            <tr>
                <td colspan="2" align="center">
                    ...
                    <input type="button" id="btn_del" runat="server" style="display:none;color:#00573D;" value="Delete" class="btn btn-xs btn-warning" onclick="if (confirm('Hapus data permintaan iDEB checking?')) callback(mainPanel, 'd');" />
                </td>
            </tr>
        ...
        <dxpc:ASPxPopupControl ID="PopupSID" ClientInstanceName="PopupSID" runat="server" HeaderText="Permintaan iDEB Checking Lainnya" width="800px" 
                    ...
                    <td>
                        <table width="100%">
                            ...
                            <tr>
                                <td class="B01">Nama Customer</td>
                                <td class="BS"></td>
                                <td class="B11"><asp:TextBox ID="find_name" runat="server" Width="200px" MaxLength="100" onkeydown="if (event.keyCode == 13) { callback(PNL_FindExisting, 'f:'); }" ></asp:TextBox></td>
                            </tr>
                            <tr>
                                <td class="B01">Requestid/Whitelistid</td>
                                <td class="BS"></td>
                                <td class="B11"><asp:TextBox ID="find_reqid" runat="server" Width="200px" MaxLength="20" onkeydown="if (event.keyCode == 13) { callback(PNL_FindExisting, 'f:'); }"></asp:TextBox></td>
                            </tr>
                            <tr>
                                <td class="B01">&nbsp;</td>
                                <td class="BS"></td>

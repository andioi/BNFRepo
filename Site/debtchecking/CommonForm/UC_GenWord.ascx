...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UC_GenWord.ascx.cs" Inherits="DebtChecking.CommonForm.UC_GenWord" %>
<table class="Tbl0" id="tbm" runat="server">
    <tr>
	    <td class="H1" colspan="2">
	        <asp:Label ID="lbT" runat="server" Text="Generate Word Document"></asp:Label>
	    </td>
    </tr>
	<tr valign="top">
		<td width="30%">

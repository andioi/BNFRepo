<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BulkRecalculate.aspx.cs" Inherits="DebtChecking.SLIK.BulkRecalculate" %>
    ...
    <dxp:PanelContent ID="PanelContent1" runat="server">
        ...
        <td> 
                ...
                <table width="100%">
                    <tr>
                       ...
                       "if(this.value=='Expand All')
                        ...
                        }"    value="Expand All" style="display:none"  />
            ...
            <tr>
                ...
                AutoGenerateColumns="False" OnLoad="grid_Load" OnCustomCallback="grid_CustomCallback" >
             ...
             <tr style="height:1%"><td>
                 ...
                 <tr class="F1">
                    <td align="center">
                         ...
                         <input class="Bt1" type="button" value="  Recalculate  " 
                         onclick="sta=confirm('Confirm to recalculate, Are you sure?');
                                  if(sta)callback(grid,'confirm',false)"  />
                     </td>
                  </tr>
             </table>
        </td>

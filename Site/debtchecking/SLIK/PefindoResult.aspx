<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PefindoResult.aspx.cs" Inherits="DebtChecking.Facilities.PefindoResult" %>
...
<body onload="callback(mainPanel, 'load', false, null);">
    ...
    <div>Select other customer in this requestid <asp:DropDownList ID="ddl_appid" runat="server" onchange="callback(mainPanel, 'r:'+this.value, false, null);"></asp:DropDownList>

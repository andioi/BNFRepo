<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SLIKNotFound.aspx.cs" Inherits="DebtChecking.Facilities.SLIKNotFound" MaintainScrollPositionOnPostback="False" %>
...
<head runat="server">
    ...
    #page_1 {position:relative; overflow: hidden;margin: 53px 0px 41px 74px;padding: 0px;border: none;}
    #page_1 #id_1 {border:none;margin: 1px 0px 0px 1px;padding: 0px;border:none;overflow: hidden;width:900px;}
    #page_1 #id_2 {border:none;margin: 16px 0px 0px 45px;padding: 0px;border:none;overflow: hidden;width:900px;}
    #page_1 #id_2 #id_2_1 {float:left;border:none;margin: 11px 0px 0px 30px;padding: 0px;border:none;overflow: hidden;}
    #page_1 #id_2 #id_2_2 {float:right;border:none;margin: 0px 65px 0px 0px;padding: 0px;border:none;overflow: hidden;}
    #page_1 #id_3 {border:none;margin: 20px 0px 0px 0px;padding: 0px;border:none;overflow: hidden;}

    #page_1 #p1dimg1 {position:absolute;top:0px;left:0px;z-index:-1;height:917px;}
    #page_1 #p1dimg1 #p1img1 {height:917px;}

    #page_1 #p1inl_img1 {position:relative;height:24px;}



    .dclr {clear:both;float:none;height:1px;margin:0px;padding:0px;overflow:hidden;}

    .ft0{font: 19px 'Arial';color: #f24f4f;line-height: 22px;}
    .ft1{font: 13px 'Arial';color: #4c483d;line-height: 16px;}
    .ft2{font: italic 11px 'Arial';line-height: 12px;}
    .ft3{font: bold 13px 'Arial';color: #ffffff;line-height: 16px;}
    .ft4{font: 11px 'Arial';color: #f24f4f;line-height: 12px;}
    .ft5{font: 1px 'Arial';line-height: 1px;}
    .ft6{font: 11px 'Arial';color:black;line-height: 12px;}
    .ft7{font: 1px 'Arial';line-height: 7px;}
    .ft8{font: bold 24px 'Arial';color: #f24f4f;line-height: 29px;}
    .ft9{font: bold 13px 'Arial';color: #f24f4f;line-height: 16px;}
    .ft10{font: bold 8px 'Arial';line-height: 10px;}
    .ft11{font: italic 8px 'Arial';line-height: 11px;}
    ...
    .p6{text-align: left;padding-left: 37px;margin-top: 0px;margin-bottom: 0px;white-space: nowrap;}
    .p7{text-align: center;}

    .td0{padding: 0px;margin: 0px;width: 85%;vertical-align: bottom;}
    .td1{padding: 0px;margin: 0px;width: 15%;vertical-align: bottom;background: #e4e3e2;}
    .td2{padding: 0px;margin: 0px;width: 270px;vertical-align: bottom;}
    .td3{padding: 0px;margin: 0px;width: 95px;vertical-align: bottom;}
    .td4{padding: 0px;margin: 0px;width: 168px;vertical-align: bottom;}
    .td5{padding: 0px;margin: 0px;width: 135px;vertical-align: bottom;}
    .td6{border-bottom: #f24f4f 1px solid;padding: 0px;margin: 0px;width: 135px;vertical-align: bottom;}
    .td7{border-bottom: #f24f4f 1px solid;padding: 0px;margin: 0px;width: 95px;vertical-align: bottom;}
    .td8{border-bottom: #f24f4f 1px solid;padding: 0px;margin: 0px;width: 168px;vertical-align: bottom;}
    .td9{border-bottom: #f24f4f 1px solid;padding: 0px;margin: 0px;width: 152px;vertical-align: bottom;}
    .td10{padding: 0px;margin: 0px;width: 624px;vertical-align: bottom;}
    ...
    .t0{width: 900px;font: 11px 'Arial';color: #f24f4f;}
    .t1{width: 900px;margin-left: 1px;margin-top: 605px;font: bold 8px 'Arial';}
...
<center><input type="button" id="btnprint" value="Print" onclick="this.style.display='none';window.print();this.style.display='';" style="display:none"  /></center>
...
<TR>
	<TD colspan=4 class="tr0 td0"><P class="p3 ft2">Informasi diberikan berdasarkan laporan yang dikirimkan oleh pelapor ke dalam Sistem Layanan Informasi Keuangan</P></TD>
	<TD class="tr0 td1"><P class="p4 ft4">Nomor Laporan</P></TD>
</TR>
<TR>
	<TD colspan=2 class="tr1 td2"><P class="p3 ft2">dengan kata kunci pencarian sebagai berikut:</P></TD>
	<TD class="tr1 td3"><P class="p5 ft5">&nbsp;</P></TD>
	<TD class="tr1 td4"><P class="p5 ft5">&nbsp;</P></TD>
	<TD class="tr1 td1"><P class="p5 ft5">&nbsp;</P></TD>
</TR>
<TR>
	<TD class="tr2 td5"><P class="p3 ft4">Nama</P></TD>
	<TD class="tr2 td5"><P class="p5 ft5">&nbsp;</P></TD>
	<TD class="tr2 td3"><P class="p5 ft5">&nbsp;</P></TD>
	<TD class="tr2 td4"><P class="p6 ft4">Jenis Kelamin</P></TD>
	<TD class="tr2 td1"><P class="p4 ft4">Posisi Data Terakhir</P></TD>
</TR>
<TR>
	<TD class="tr3 td5"><P class="p3 ft6"><%=DS(0, "permutasi_name") %></P></TD>
	<TD class="tr3 td5"><P class="p5 ft5">&nbsp;</P></TD>
	<TD class="tr3 td3"><P class="p5 ft5">&nbsp;</P></TD>
	<TD class="tr3 td4"><P class="p6 ft6"><NOBR><%=DS(0, "gender") %></NOBR></P></TD>
	<TD class="tr3 td1"><P class="p4 ft6"><NOBR><%=DS(0, "position_date") %></NOBR> <%=DS(0, "position_time") %></P></TD>
</TR>
<TR>
	<TD class="tr4 td5"><P class="p3 ft4">No. Identitas</P></TD>
	<TD class="tr4 td5"><P class="p5 ft4">NPWP</P></TD>
	<TD class="tr4 td3"><P class="p5 ft4">Tempat Lahir</P></TD>
	<TD class="tr4 td4"><P class="p6 ft4">Tanggal Lahir</P></TD>
	<TD class="tr4 td1"><P class="p4 ft4">Tanggal Permintaan</P></TD>
</TR>
<TR>
	<TD class="tr1 td5"><P class="p5 ft6"><%=DS(0, "id_number") %></P></TD>
	<TD class="tr1 td5"><P class="p5 ft6"><%=DS(0, "npwp") %></P></TD>
	<TD class="tr1 td3"><P class="p5 ft6"><%=DS(0, "place_of_birth") %></P></TD>
	<TD class="tr1 td4"><P class="p6 ft6"><NOBR><%=DS(0, "date_of_birth") %></NOBR></P></TD>
	<TD class="tr1 td1"><P class="p4 ft6"><NOBR><%=DS(0, "request_date") %></NOBR></P></TD>
</TR>
<TR>
	<TD class="tr5 td5"><P class="p5 ft7">&nbsp;</P></TD>
	<TD class="tr5 td5"><P class="p5 ft7">&nbsp;</P></TD>
	<TD class="tr5 td3"><P class="p5 ft7">&nbsp;</P></TD>
	<TD class="tr5 td4"><P class="p5 ft7">&nbsp;</P></TD>
	<TD class="tr5 td1"><P class="p5 ft7">&nbsp;</P></TD>
</TR>
<TR>
	<TD class="tr6 td6"><P class="p5 ft5">&nbsp;</P></TD>
	<TD class="tr6 td6"><P class="p5 ft5">&nbsp;</P></TD>
	<TD class="tr6 td7"><P class="p5 ft5">&nbsp;</P></TD>
	<TD class="tr6 td8"><P class="p5 ft5">&nbsp;</P></TD>
	<TD class="tr6 td9"><P class="p5 ft5">&nbsp;</P></TD>
</TR>
<tr>
    <td colspan="5"><P class="p7 ft8">### Data Tidak Ditemukan ###</P></td>
</tr>
</TABLE>

<TABLE cellpadding=0 cellspacing=0 class="t1">
<TR>
	<TD class="tr7 td10"><P class="p5 ft11">Nomor Laporan <SPAN class="ft9">| </SPAN>Operator <SPAN class="ft10">[UserName] </SPAN><SPAN class="ft9">| </SPAN>Tanggal Permintaan <NOBR><SPAN class="ft10"><%=DS(0, "request_date") %></SPAN></NOBR></P></TD>
	<TD class="tr7 td11"><P class="p5 ft12">1 dari 1</P></TD>
</TR>
<TR>
	<TD class="tr8 td10"><P class="p5 ft11">Posisi Data Terakhir <NOBR><SPAN class="ft10"><%=DS(0, "position_date") %></SPAN></NOBR><SPAN class="ft10"> <%=DS(0, "position_time") %> </SPAN><SPAN class="ft9">| </SPAN><SPAN class="ft10">[UserType]</SPAN><SPAN class="ft9">| </SPAN>Peruntukkan <SPAN class="ft10"><%=DS(0, "request_purpose") %> </SPAN><SPAN class="ft9">| </SPAN>Tanggal Cetak <NOBR><SPAN class="ft10"><%=DS(0, "request_date") %></SPAN></NOBR></P></TD>
	<TD class="tr8 td11"><P class="p5 ft5">&nbsp;</P></TD>
</TR>
</TABLE>
</DIV>
</DIV>
